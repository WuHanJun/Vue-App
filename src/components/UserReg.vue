<template>
    <div class="content">
        <p class="fhbtn"><a href="javascript:;" onclick="window.history.go(-1)"><span class="iconfont icon-arrow-left"></span></a></p>
        <h1></h1>
        <div class="login-box">
            <p class="lsolid"></p>
            <div class="login">
...
<style scoped>
   .content{ background:#f3f3f3;}
    ...
    .content .fhbtn a{ display:block; margin-left:0.3rem;}
   .content .fhbtn .iconfont {font-size: .5rem;}
    .content h1{width:2.18rem;height:1.35rem; background:url("../assets/images/logo.png") no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
